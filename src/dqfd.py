...
def train(name="dqfd", priority=True):
    ...
    while frame_number < MAX_FRAMES:
        ...
        if len(episode_len_list) % print_iter == 0:
            ...
            logger.record_tabular("Last " + str(print_iter) + " Episodes Reward: ", np.mean(episode_reward_list[-print_iter:]))
            logger.record_tabular("Last " + str(print_iter) + " Episodes Length: ", np.mean(episode_len_list[-print_iter:]))
            logger.record_tabular("Last " + str(print_iter) + " Episodes Loss: ", np.mean(episode_loss_list[-print_iter:]))
            logger.record_tabular("Last " + str(print_iter) + " Episodes Time: ", np.mean(episode_time_list[-print_iter:]))
            ...
            logger.record_tabular("Last " + str(print_iter) + " Expert Ratio: ", np.mean(episode_expert_list[-print_iter:]))
            logger.record_tabular("Total " + str(print_iter) + " Episode time: ", np.sum(episode_time_list[-print_iter:]))
